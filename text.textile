...
For any of these examples, you can find a link to the most current Git source code at 
"git.or.cz":http://git.or.cz/
...
, which you can get from Google Code, and has just recently been linked to as the "official" Mac version on the Git homepage.  Just download and run the dmg from the website.
