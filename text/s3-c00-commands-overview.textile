...
h4. "git config":http://www.kernel.org/pub/software/scm/git/docs/git-config.html
...
h4. "git init":http://www.kernel.org/pub/software/scm/git/docs/git-init.html

Initializes a git repository - creates the initial '.git' directory in a new or existing project.

h4. "git clone":http://www.kernel.org/pub/software/scm/git/docs/git-clone.html
...
h4. "git add":http://www.kernel.org/pub/software/scm/git/docs/git-add.html

Adds changes in files in your working directory to your index, or staging area.

h4. "git rm":http://www.kernel.org/pub/software/scm/git/docs/git-rm.html

Removes files from your index and your working directory so they will stopped being tracked.

h4. "git commit":http://www.kernel.org/pub/software/scm/git/docs/git-commit.html 
...
h4. "git status":http://www.kernel.org/pub/software/scm/git/docs/git-status.html
...
h4. "git branch":http://www.kernel.org/pub/software/scm/git/docs/git-branch.html
...
h4. "git checkout":http://www.kernel.org/pub/software/scm/git/docs/git-checkout.html
...
h4. "git merge":http://www.kernel.org/pub/software/scm/git/docs/git-merge.html

Merges one or more branches into your current branch and automatically creates a new commit if there are no conflicts.

h4. "git reset":http://www.kernel.org/pub/software/scm/git/docs/git-reset.html
...
h4. "git rebase":http://www.kernel.org/pub/software/scm/git/docs/git-rebase.html
...
h4. "git stash":http://www.kernel.org/pub/software/scm/git/docs/git-stash.html

Temporarily saves changes that you don't want to commit immediately for later.  Can re-apply the saved changes at any time.

h4. "git tag":http://www.kernel.org/pub/software/scm/git/docs/git-tag.html

Tags a specific commit with a simple, human readable handle that never moves.

h4. "git fetch":http://www.kernel.org/pub/software/scm/git/docs/git-fetch.html
...
h4. "git pull":http://www.kernel.org/pub/software/scm/git/docs/git-pull.html

Runs a 'git fetch' then a 'git merge'.

h4. "git push":http://www.kernel.org/pub/software/scm/git/docs/git-push.html
...
h4. "git remote":http://www.kernel.org/pub/software/scm/git/docs/git-remote.html
...
h4. "git log":http://www.kernel.org/pub/software/scm/git/docs/git-log.html
...
h4. "git show":http://www.kernel.org/pub/software/scm/git/docs/git-show.html

Shows information about a git object, normally used to view commit information.

h4. "git ls-tree":http://www.kernel.org/pub/software/scm/git/docs/git-ls-tree.html
...
h4. "git cat-file":http://www.kernel.org/pub/software/scm/git/docs/git-cat-file.html
...
h4. "git grep":http://www.kernel.org/pub/software/scm/git/docs/git-grep.html

Lets you search through your trees of content for words and phrases without having to actually check them out.

h4. "git diff":http://www.kernel.org/pub/software/scm/git/docs/git-diff.html
...
h4. "gitk":http://www.kernel.org/pub/software/scm/git/docs/gitk.html

Graphical Tcl/Tk based interface to a local Git repository.

h4. "git instaweb":http://www.kernel.org/pub/software/scm/git/docs/git-instaweb.html
...
h4. "git archive":http://www.kernel.org/pub/software/scm/git/docs/git-archive.html
...
h4. "git gc":http://www.kernel.org/pub/software/scm/git/docs/git-gc.html
...
h4. "git fsck":http://www.kernel.org/pub/software/scm/git/docs/git-fsck.html

Does an integrity check of the Git "filesystem", identifying dangling pointers and corrupted objects.

h4. "git prune":http://www.kernel.org/pub/software/scm/git/docs/git-prune.html

Removes objects that are no longer pointed to by any object in any reachable branch.

h4. "git-daemon":http://www.kernel.org/pub/software/scm/git/docs/git-daemon.html
